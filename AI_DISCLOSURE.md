...
2. **What specific things did you ask them to do?** (Be specific)
   ...
   I used for minimal assistance with grammar checking,and understanding 
   errors when my code was not working.
...
3. **How much of your final code came from AI vs. your own work?** (e.g., "AI gave me the formula, I wrote the loop" or "AI helped me debug an error")
   The code, analysis and results were completed by me.Ai was only 
   used for debugging errors and understanding errors.
